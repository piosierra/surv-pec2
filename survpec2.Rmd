...
pattern <- data.frame(age_65=0, gender = 0.5, mitype = 0, miord = 0, hr_85 = 0, chf = 0)
...
pattern<- data.frame(age_65=0, gender = 0.5, mitype = 1, miord = 0, hr_85 = 0, chf = 0)
plot(survfit(modelo2, newdata=pattern), main = "miord=0, mitype=1")
pattern<- data.frame(age_65=0, gender = 0.5, mitype = 0, miord = 1, hr_85 = 0, chf = 0)
plot(survfit(modelo2, newdata=pattern), main = "miord=1, mitype=0")
pattern<- data.frame(age_65=0, gender = 0.5, mitype = 1, miord = 1, hr_85 = 0, chf = 0)
...
```
Comporbamos que el valor de la mediana es el mismo en todos y coindice con el límite de eventos observados.  
...
Tercero comprobamos la signifiación de los productos con el tiempo.
