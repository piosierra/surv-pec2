...
plot(survfit(modelo2, newdata=pattern), xlab = "Curva de superviviencia ajustada para:\n age_65 = 0, gender = 0.5, mitype = 0, miord = 0, hr_85 = 0, chf = 0")
...
```{r}
plot(survfit(data$surv ~ data$gender), fun="cloglog",xlab="time in days using log-
arithmic scale",ylab="log-log survival", main="log-log curves by gender")
```
...
```{r}
modpar1=survreg(surv ~ gender + age_65 + hr_85 + chf + diasbp + bmi,  data=data,dist="exponential")
summary(modpar1)
modpar2=survreg(surv ~ gender + age_65 + hr_85 + chf + diasbp + bmi,  data=data,dist="weibull")
summary(modpar1)
modpar3=survreg(surv ~ gender + age_65 + hr_85 + chf + diasbp + bmi,  data=data,dist="loglogistic")
summary(modpar1)
...
```{r}
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + gender*age_65, data=data,dist="weibull")
print(paste("gender*age_65: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + bmi*age_65, data=data,dist="weibull")
print(paste("bmi*age_65: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + diasbp*age_65, data=data,dist="weibull")
print(paste("diasbp*age_65: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + chf*age_65, data=data,dist="weibull")
print(paste("chf*age_65: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + hr_85*age_65, data=data,dist="weibull")
print(paste("hr_85*age_65: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + gender*hr_85, data=data,dist="weibull")
print(paste("gender*hr_85: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + bmi*hr_85, data=data,dist="weibull")
print(paste("bmi*hr_85: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + diasbp*hr_85, data=data,dist="weibull")
print(paste("diasbp*hr_85: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + chf*hr_85, data=data,dist="weibull")
print(paste("chf*hr_85: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + gender*chf, data=data,dist="weibull")
print(paste("gender*chf: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + chf*diasbp, data=data,dist="weibull")
print(paste("chf*diasbp: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + chf*bmi, data=data,dist="weibull")
print(paste("chf*bmi: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + gender*bmi, data=data,dist="weibull")
print(paste("gender*bmi: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + diasbp*bmi, data=data,dist="weibull")
print(paste("bmi*diasbp: ", lrt.surv(modpar1,modpar2, 6)))
modpar1=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi,   data=data,dist="weibull")
modpar2=survreg(surv ~  gender + age_65 + hr_85 + chf + diasbp + bmi + gender*diasbp, data=data,dist="weibull")
...
Creamos el modelo de Cox con las variables de g)
...
plot(survfit(modcox, newdata=pattern), xlab = "Curva de superviviencia del modelo de Cox ajustada para:\n age_65 = 0, gender = 0.5, mitype = 0, miord = 0, hr_85 = 0, chf = 0")
